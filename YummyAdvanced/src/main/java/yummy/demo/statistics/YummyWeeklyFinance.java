...
public class YummyWeeklyFinance {
    ...
    public YummyWeeklyFinance(double totalTransactionAmount, int totalOrderNum, double totalProfit, ArrayList<Double> transactionAmountList, ArrayList<Integer> orderNumList, ArrayList<Double> profitList) {
