...
public class YummyWeeklyFinance {
    ...
    public YummyWeeklyFinance(double totalTransactionAmount, int totalOrderNum, double totalProfit, List<Double> transactionAmountList, List<Integer> orderNumList, List<Double> profitList) {
