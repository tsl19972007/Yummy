...
public class YummyAnnualFinance {
    /*
    交易金额
     */
    ...
    public YummyAnnualFinance(double totalTransactionAmount, int totalOrderNum, double totalProfit, ArrayList<Double> transactionAmountList, ArrayList<Integer> orderNumList, ArrayList<Double> profitList) {
