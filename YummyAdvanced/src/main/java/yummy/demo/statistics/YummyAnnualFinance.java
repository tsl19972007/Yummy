...
public class YummyAnnualFinance {
    ...
    public YummyAnnualFinance(double totalTransactionAmount, int totalOrderNum, double totalProfit, List<Double> transactionAmountList, List<Integer> orderNumList, List<Double> profitList) {
